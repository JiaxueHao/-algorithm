...
//商品浏览记录：最新浏览的排在前面，增加，删除，查询商品，最多只保存 MAX_CACHE_SIZE 个商品
//新添加的为头节点，之前的为尾节点

public class LRU_GoodsBrowse<K, V> {
    ...
    //初始哈希表为空，长度为0
    public LRU_GoodsBrowse(int cacheSize) {
...
//更新尾节点
    ...
    public static void main(String[] args) {
        LRU_GoodsBrowse<Integer, Integer> lru2 = new LRU_GoodsBrowse<>(5);
